\documentclass[DIV10, parskip=full*, headings=big, 10.5pt,
   			bibliography=totoc, listof=totoc, BCOR=12mm, twoside=false,
...
\usepackage[lmargin=2.5cm,rmargin=2.5cm,tmargin=3cm,bmargin=3.3cm]{geometry}
...
\renewcommand{\includegraphics}[2][]{%
  \latexincludegraphics[width=\textwidth-30pt,#1]{#2}}%
...
\fontfamily{ppl}\fontseries{m}\selectfont
...
\lstset{
        ...
        emph={double,bool,int,unsigned,char,true,false,void,=>},
				...
				emph={Assert,Test},
				emphstyle=\color{black},
				emph={[2]\using,\#define,\#ifdef,\#endif}, emphstyle={[2]\color{black}},
		basicstyle=\small\ttfamily,
...
%\deffootnote[1em]{2em}{1em}{\textsuperscript{\thefootnotemark}\,}
\deffootnote[1em]{1.1em}{1.6em}{\textsuperscript{\thefootnotemark}\,}
...
\begin{figure}[htbp]
  \begin{minipage}[t][3cm][c]{\textwidth/2+1.7cm}
		...
		\latexincludegraphics[height=3.5em]{figures/tud.pdf}  

  \end{minipage}
  \begin{minipage}[t][3cm][c]{\textwidth/2-1.7cm}
	\begin{flushright}  	
  	\latexincludegraphics[height=3.5em]{figures/logo.pdf}
	\end{flushright}
  \end{minipage}
\end{figure}
